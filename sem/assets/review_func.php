        ...
        <img src='../user_images/$user_img' alt = 'user pic'>
            <div class='review_details'>
              <div class='review_links'>
                  ...
                  <div class='links'>
                      <a href='review.php?id_review=$id_review'>$review_name</a>
                      <a href='book.php?id_book=$id_book'>$book_name</a>
                      <span>
                      ";
...
function getAllReviews($id_book): void
{
    ...
    global $conn;
    $result = $conn->query("SELECT id_review FROM review WHERE id_book = '$id_book'");
...
function getReviewsByUser($id_user):void
{
    global $conn;
